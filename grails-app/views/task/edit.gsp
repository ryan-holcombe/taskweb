                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: taskInstance, field: 'name', 'errors')}">
                                    <g:textField name="title" value="${taskInstance?.name}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: taskInstance, field: 'assignedTo', 'errors')}">
                                    <g:select name="assignedTo.id" from="${com.honeydothis.User.list()}" optionKey="id" value="${taskInstance?.assignedTo?.id}" noSelection="['null': '']" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: taskInstance, field: 'taskGroup', 'errors')}">
                                    <g:select name="taskGroup.id" from="${com.honeydothis.TaskGroup.list()}" optionKey="id" value="${taskInstance?.taskGroup?.id}"  />
                                </td>
                            </tr>
