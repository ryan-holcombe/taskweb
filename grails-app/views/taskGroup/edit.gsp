                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="login"><g:message code="taskGroup.login.label" default="Login" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: taskGroupInstance, field: 'login', 'errors')}">
                                    <g:select name="login.id" from="${com.honeydothis.Login.list()}" optionKey="id" value="${taskGroupInstance?.login?.id}"  />
                                </td>
                            </tr>
