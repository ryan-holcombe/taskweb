            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="taskGroup.login.label" default="Login" /></td>
                            
                            <td valign="top" class="value"><g:link controller="login" action="show" id="${taskGroupInstance?.login?.id}">${taskGroupInstance?.login?.encodeAsHTML()}</g:link></td>
